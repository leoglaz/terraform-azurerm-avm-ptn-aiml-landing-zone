...
resource_group_name = "rg-aiml2-lz-dev-canadacentral"
...
ai_foundry_definition = {
 ...
 # AI Model Deployments - Disabled
  ...
  storage_account_definition = {
    project1 = {
      name                       = "stproject1aiml002l"  # Must be globally unique
...
genai_key_vault_definition = {
  name                          = "kv-genai-s12-l"
  sku                           = "standard"
  public_network_access_enabled = true  # Temporarily enabled for initial deployment
}

# Storage Account for GenAI
genai_storage_account_definition = {
  deploy                   = true
  name                     = "stgenaiaiml0022l"  # Must be globally unique
  account_tier             = "Standard"
...
private_dns_zones = {
  ...
  existing_zones_resource_group_resource_id = "/subscriptions/1d5b5f8a-d3d1-4a17-b061-00bf1db56490/resourceGroups/rg-aiml2-lz-dev-canadacentral"
